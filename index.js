...
module.exports = {
  ...
  getFuzzyTimezoneFromPoint: getFuzzyTimezoneFromPoint,
...
/**
 * Returns the timezone id at the point of interest.
 * @param  {Array}   point       a [lng, lat] point of interest
 * @return {string}              a timezone string object
 */
function getFuzzyTimezoneFromPoint(point) {
  var tile = tilebelt.pointToTile(point[0], point[1], z).join('/');
  var locale = tiles[tile];
